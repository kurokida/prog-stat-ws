...
expName = 'test3'  # from the Builder filename that created this script
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    slider = visual.Slider(win=win, name='slider',
        startValue=None, size=(0.8,0.02), pos=(0, -0.3), units=win.units,
        labels=["美しくない","やや美しくない","どちらともいえない","やや美しい","美しい"], ticks=(1, 2, 3, 4, 5), granularity=1.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor=[-1.0000, -1.0000, -1.0000], markerColor=[0.0902, -1.0000, -1.0000], lineColor='White', colorSpace='rgb',
        font='Meiryo', labelHeight=0.02,
    ...
    for thisTrial in trials:
        ...
        trialComponents = [text_fixation, image, slider]
