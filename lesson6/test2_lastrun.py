...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\daiic\\OneDrive - Kyushu University\\学内ワークショップ\\prog-stat-ws-github\\lesson6\\test2_lastrun.py',
...
# --- Setup the Window ---
win = visual.Window(
    size=[1664, 1109], fullscr=True, screen=0, 
...
for thisTrial in trials:
    ...
    trialComponents = [text_fixation, polygon, key_resp, image]
    ...
    while continueRoutine:
        ...
        if image.status == NOT_STARTED and tThisFlip >= 3-frameTolerance:
            # keep track of start time/frame for later
